...
export class UserRepository implements IUserRepository {
  ...
  async findUserInList(userIds: string[]) {
  ...
  async findUserWithoutPasswordById(id: string) {
    const queryConfig: QueryConfig = {
      text: `
      SELECT
          u.id,
  ...
  async findUserWithoutPasswordByEmail(email: string) {
    const queryConfig: QueryConfig = {
      text: `
        SELECT
            u.id,
  ...
  async findUsers(query: UserRequsetType["Query"]["Querystring"]) {
    const queryString = [
      `
      SELECT
          u.id,
  ...
  async createNewUser(data: UserRequsetType["Create"]["Body"]) {

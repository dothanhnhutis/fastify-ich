...
VALUES
    ('Nha Kho', '102 nguyen dinh chieu'),
    ('Nha may', '159 nguyen dinh chieu')
RETURNING
    *;
...
WHERE
    id IN (
        ...
        FROM
            user_roles
        WHERE
            user_id = '09a2d9aa-2981-4fcf-8084-9704ab5043c4'
    );

---
DELETE FROM roles
WHERE
    id = '50cffaeb-1b75-4834-a18c-189b85f9c276';
...
FROM
    roles
WHERE
    permissions = ALL ('read:warehouse:*') -- WHERE name ILIKE '%Manager update%';
    ---
SELECT
    *
FROM
...
FROM
    roles
WHERE
    permissions @> ARRAY['read:warehouse:*', 'read:role:*'];
...
SET
    "audit.user" = "09095ad4-fb22-4e24-b209-0d8e6c47064f";

INSERT INTO
    packaging_transactions (type, note)
VALUES
    ('IMPORT'::transaction_type, 'nhap kho san pham A')
RETURNING
    *;
...
VALUES
    ('49c083c5-b280-4803-829c-e3e500fcf4db', "CREATE",);
...
WHERE
    p.id = 'a4bb912b-9e69-4477-86aa-c1600058fc78'
GROUP BY
    p.id;
...
SET
    quantity = (
        ...
        FROM
            packaging_transaction_items
        WHERE
            packaging_stock_id = 'aac02c2b-f611-448c-884d-1e6946cec664'
    )
WHERE
    id = 'aac02c2b-f611-448c-884d-1e6946cec664'
RETURNING
    *;